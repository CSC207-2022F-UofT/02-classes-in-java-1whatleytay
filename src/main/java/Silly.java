...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two strings, `first` and `second`.
     * The name value for this Silly object will be set to the concatenation of both `first` and `second`.
     * @param first The leading part for the name value (appended by `second` to get this.name).
     * @param second The trailing part for the name value (prefixed by `first` to get this.name).
     */
